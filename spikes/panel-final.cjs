...
if (!zh['panel.directory']) {
  ...
  zh['export.hint'] = '将导出当前会话的完整聊天记录为 Markdown 文件。';
  zh['export.include'] = '包含：消息内容、角色、时间戳';
  zh['common.more'] = '更多';
  en['panel.directory'] = 'Directory';
  en['export.hint'] = 'Export the full chat history as a Markdown file.';
  en['export.include'] = 'Includes: messages, roles, timestamps';
  en['common.more'] = 'More';
